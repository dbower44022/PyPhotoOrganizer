...
class ImportHistoryTab(QWidget):
        ...
        try:
            ...
            with profile_block("Pre-compute filtered views (optimized single-pass)", logger):
                ...
                for log in all_logs:
                    ...
                    elif op == 'archive_recovery':
                        self._archive_recovery_logs.append(log)
    ...
    def _apply_show_filter(self):
        ...
        elif show == "Archive Recovery":
            self._model.setData(getattr(self, '_archive_recovery_logs', []))
        elif show == "Errors":
